...
from brainbox.core.prompts import PromptBuilder, SimpleQAPrompt
...
class SimplePipeline(Pipeline):
    def __init__(
        self, 
        client: LLMClient, 
        prompt_builder_cls: Type[PromptBuilder] = SimpleQAPrompt
    ):
        self.client = client
    ...
    def run(self, input_data: str) -> Dict[str, Any]:
        ...
        # Build Prompt
        prompt_builder = self.prompt_builder_cls(question=question)
